...
from traject_data import rest
from traject_data.configuration import Configuration
from traject_data.exceptions import ApiTypeError, ApiValueError, ApiException
from traject_data.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = SerpApi()
        api_instance.get_engine_locale  # this is an instance of the class Endpoint
        api_instance.get_engine_locale()  # this invokes api_instance.get_engine_locale.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_engine_locale.callable or self.callable in this class
